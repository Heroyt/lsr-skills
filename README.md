...
### PSR logger compatibility set

The following versions are now released and support PSR-3 logger contracts:

| Package | Released version | Compatibility change |
| --- | --- | --- |
| `lsr/core` | `0.6.0` | PSR getter/setter/protected property; supports ORM 0.3 and 0.4 |
| `lsr/orm` | `0.4.0` | PSR provider/getters/protected property; concrete default provider retained |
| `lsr/roadrunner` | `0.1.17` | Admit Core `^0.6` and ORM `^0.4` |
| `lsr/cqrs` | `0.1.7` | Admit Core `^0.6` |
| `lsr/auth` | `0.3.13` | Admit ORM `^0.4` |
